                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="details"> <b>Avatar Details</b>
                                        <div class="txt">Name and Task of Avatar</div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input class="form-control" name="avatar_name"
                                                    placeholder="Type Avatar Name" />
                                            </div>
                                            <div class="col-md-6">
                                                <input class="form-control" name="avatar_task"
                    ...
                    @foreach ($avatars as $av)
                        ...
                        <div class="show_details" cid="{{ $av->id }}">
                            <div class="text-center ">
                                @if ($av->image != '')
                                    <img src="{{ asset('/images/' . $av->image) }}" alt=""
                    ...
                    <div class="avatar_details">
                        <div class="row">
                            <div class="col-sm-7">
                                ...
                                <div class="details av_join">
                                    {{ \Carbon\Carbon::parse($mainav->created_at)->format('d, m Y') }}</div>
                            ...
                            <div class="postbox">
                                ...
                                <div class="post-innter">
                                    ...
                                    <div class="post_avatar">
                                        <div class="heading_post av_name">{{ $mainav->name }}</div>
                                        <div class="details_post av_task">&nbsp;&nbsp;{{ $mainav->task }}</div>
                                    </div>
                                    <div class="post_time">
                                        Online in 05:12
                                    </div>
                                    @if ($feed->imageUrl)
                                    <div class="post_img">
                                        <img src="{{ url('storage/'.$feed->imageUrl) }}" />
                                    </div>
                                    @endif
                                    ...
                                    <div class="col-sm-6 artilce_title">
                                        <button class="btn btn-danger btn-share btn-share-denied">Denied to Share
                                            <span>&#9746;</span></button>
                                    </div>
