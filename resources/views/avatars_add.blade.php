            ...
            <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="bordered">
                                        ...
                                        <input type="radio" id="alluser" name="sharing_options"
                                            value="0" />
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="bordered">
                                        ...
                                        <input type="radio" id="educated_users" name="sharing_options"
                                ...
                                <div class="col-md-6 ">
                                    <div class="bordered">
                                        ...
                                        <input type="radio" id="cul_users" name="sharing_options"
                                            value="2" />
                                    </div>
                                ...
                                <div class="col-md-6 ">
                                    <div class="bordered">
                                        ...
                                        <input type="radio" id="ac_users" name="sharing_options"
                                            value="3" />
                                    </div>
                                ...
                                <div class="col-md-6 ">
                                    <div class="bordered">
                                        <div class="form-check form-switch mb-2">Text Comments
                                            <input class="form-check-input closetogglebtn" checked="checked"
                                ...
                                <div class="col-md-6">
                                    <div class="bordered">
                                        <div class="form-check form-switch mb-2">Voice Comments
                                            <input class="form-check-input closetogglebtn" name="voice_comments"
                                                type="checkbox">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                    <div class="bordered">
                                        <div class="form-check form-switch mb-2">Share Post
                                            <input class="form-check-input closetogglebtn" name="share_post"
                                                type="checkbox">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 ">
                                    <div class="bordered">
                                        <div class="form-check form-switch mb-2">Like Post
                                            <input class="form-check-input closetogglebtn" name="like_post"
                                                type="checkbox">
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="details">
                            <h4><b>Text Setting</b>
                                <div class="form-check form-switch mb-2 righ-check-option">
                                    <input class="form-check-input closetogglebtn" name="text_settings"
                                        type="checkbox">
                                </div>
                            </h4>
                        ...
                        <div class="details">
                            <h4><b>Image Setting</b>
                                <div class="form-check form-switch mb-2 righ-check-option">
                                    <input class="form-check-input closetogglebtn" name="image_settings"
                                        type="checkbox">
                                </div>
                            </h4>
                            <div class="txt">Article Settings</div>
                        ...
                        <div class="details">
                            <h4><b>Video Setting</b>
                                <div class="form-check form-switch mb-2 righ-check-option">
                                    <input class="form-check-input closetogglebtn" name="video_settings"
                                        type="checkbox">
                                </div>
                            </h4>
                            <div class="txt">Article Settings</div>
                        ...
                        <div class="details">
                            <h4><b>Language Setting</b>
                                <div class="form-check form-switch mb-2 righ-check-option">
                                    <input class="form-check-input closetogglebtn" name="lang_settings"
                                        type="checkbox">
                                </div>
                            </h4>
                            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <button type="submit" class="btn btn-default" style="border: solid 2px;">Save
                            changes</button>
                    </div>
                </div>
            </form>
