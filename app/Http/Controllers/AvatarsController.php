...
class AvatarsController extends Controller
{
	...
	public function manag_avatars($id = 0)
	{
		...
		if ($id > 0) {
			$feeds = Feeds::where('avatar_id', $id)->get();
		} else {
			$feeds = Feeds::where('avatar_id', $avatars->first()->_id)->get();
		}
	...
	public function store(Request $request)
	{
		...
		$lang_settings = 0;
		if (isset($request['lang_settings'])) {
			$lang_settings = 1;
		}
		$lang_settings_1 = $request['lang_settings_1'];
		...
		$avatar->lang_setting = $lang_settings;
		$avatar->lang_setting_content_type = $lang_settings_1;
