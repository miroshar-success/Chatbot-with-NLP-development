...
<div class="card">
       ...
       <div class="row">
       		<div class="col-sm-2">
            	...
            	<?php $__currentLoopData = $avatars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $av): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="show_details" cid="<?php echo e($av->id); ?>">
            ...
            <div class="col-sm-4 ">
            	...
            	<div class="row">
                	<div class="col-sm-7">
                    	<div class="heading av_name"><?php echo e($mainav->name); ?></div>
                        <div class="details av_task"><?php echo e($mainav->task); ?></div>
                        
                        <div class="heading">Join Date</div>
                        <div class="details av_join"><?php echo e(\Carbon\Carbon::parse($mainav->created_at)->format('d, m Y')); ?></div>
                    ...
                    <div class="col-sm-5">
                    	<?php if($mainav->image != ""): ?>
                        	<img class="av_image" src="<?php echo e(asset('/images/' . $mainav->image)); ?>" />
                        <?php else: ?>
            	...
            	<div class="avatar_details">
                    ...
                    <div class="postbox">
                        ...
                        <div class="post-innter">
                            ...
                            <div class="post_img">
                                <img src="<?php echo e(asset('/images/post.png')); ?>" />
                            </div>
                        ...
                        <div class="post-innter">
                            ...
                            <div class="col-sm-12 ">
                            	...
                            	<div class="shares_options">
                                	<img class="shareimg" src="<?php echo e(asset('/images/share.png')); ?>" />
                                </div>
                            </div>
  ...
  <!--/ Basic Bootstrap Table -->
	...
	<script>
		var url = "<?php echo e(url('/get-avatars/')); ?>";
		var imgurl = "<?php echo e(asset('')); ?>";
	...
	</script><?php /**PATH E:\code\mongodb\my-app\resources\views/manag_avatars.blade.php ENDPATH**/ ?>